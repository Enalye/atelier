...
import atelier.common, atelier.render, atelier.core;
...
final class RippleEffect {
    ...
    void onPress(bool isPressed_) {
        if (isPressed_) {
            ...
            _pressedRipple.x = Atelier.ui.pressedX;
            _pressedRipple.y = Atelier.ui.pressedY;
...
final class ButtonFx {
    ...
    void update() {
        ...
        else if (_ui.pressed || _ui.focused) {
    ...
    void draw() {
        ...
        Atelier.renderer.pushCanvas(cast(int) _ui.sizeX, cast(int) _ui.sizeY);
