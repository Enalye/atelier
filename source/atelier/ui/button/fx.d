...
final class ButtonFx(ImageType) {
    ...
    this(UIElement element) {
        ...
        static if (is(ImageType == RoundedRectangle)) {
            _mask = RoundedRectangle.fill(_element.getSize(), Atelier.theme.corner);
        }
    ...
    void draw() {
        Atelier.renderer.pushCanvas(cast(int) _element.getWidth(),
        ...
        Atelier.renderer.popCanvasAndDraw(Vec2f.zero, _element.getSize(), 0f,
