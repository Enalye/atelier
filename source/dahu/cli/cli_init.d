...
void cliInit(Cli.Result cli) {
    ...
    Json json = new Json;
    json.set(Dahu_Project_DefaultConfiguration_Node, appName);

    {
        Json appNode = new Json;
        appNode.set(Dahu_Project_Name_Node, appName);
        appNode.set(Dahu_Project_Source_Node, srcPath);
        appNode.set(Dahu_Project_Export_Node, "export");

        {
            ...
            appNode.set(Dahu_Project_Resources_Node, resourcesNode);
        }
        ...
        json.set(Dahu_Project_Configurations_Node, [appNode]);
    }

    json.save(buildNormalizedPath(dir, Dahu_Project_File));
