...
package void loadLibUI(GrLibDefinition lib) {
    ...
    // Commun aux UI
    lib.addFunction(&_ui_pos, "pos", [uiType, grFloat, grFloat]);
    lib.addProperty(&_ui_posX!"get", &_ui_posX!"set", "posX", uiType, grFloat);
    lib.addProperty(&_ui_posY!"get", &_ui_posY!"set", "posY", uiType, grFloat);

    lib.addFunction(&_ui_size, "size", [uiType, grFloat, grFloat]);
    lib.addProperty(&_ui_sizeX!"get", &_ui_sizeX!"set", "sizeX", uiType, grFloat);
    lib.addProperty(&_ui_sizeY!"get", &_ui_sizeY!"set", "sizeY", uiType, grFloat);

    lib.addFunction(&_ui_scale, "scale", [uiType, grFloat, grFloat]);
    lib.addProperty(&_ui_scaleX!"get", &_ui_scaleX!"set", "scaleX", uiType, grFloat);
    lib.addProperty(&_ui_scaleY!"get", &_ui_scaleY!"set", "scaleY", uiType, grFloat);

    lib.addFunction(&_ui_pivot, "pivot", [uiType, grFloat, grFloat]);
    lib.addProperty(&_ui_pivotX!"get", &_ui_pivotX!"set", "pivotX", uiType, grFloat);
    lib.addProperty(&_ui_pivotY!"get", &_ui_pivotY!"set", "pivotY", uiType, grFloat);

    lib.addProperty(&_ui_angle!"get", &_ui_angle!"set", "angle", uiType, grFloat);

    lib.addProperty(&_ui_alpha!"get", &_ui_alpha!"set", "alpha", uiType, grFloat);

    lib.addFunction(&_ui_align, "align", [uiType, alignXType, alignYType]);
    lib.addProperty(&_ui_alignX!"get", &_ui_alignX!"set", "alignX", uiType, alignXType);
    lib.addProperty(&_ui_alignY!"get", &_ui_alignY!"set", "alignY", uiType, alignYType);

    lib.addProperty(&_ui_isHovered, null, "hover?", uiType, grBool);
    lib.addProperty(&_ui_isClicked, null, "click?", uiType, grBool);

    lib.addConstructor(&_ui_state_new, stateType, [grString]);

    lib.addFunction(&_ui_state_offset, "offset", [stateType, grFloat, grFloat]);
    ...
    lib.addFunction(&_ui_state_scale, "scale", [stateType, grFloat, grFloat]);
    ...
    lib.addFunction(&_ui_addState, "addState", [uiType, stateType]);
    lib.addFunction(&_ui_setState, "setState", [uiType, grString]);
    lib.addFunction(&_ui_runState, "runState", [uiType, grString]);

    lib.addFunction(&_ui_append_root, "appendUI", [uiType]);
    lib.addFunction(&_ui_append_child, "append", [uiType, uiType]);

    // Labels
    lib.addConstructor(&_label_new, labelType, [grString]);
    lib.addFunction(&_label_text, "text", [labelType, grString]);
}
