 ...
 * Auteur: Enalye
 */
module studio.editor.res.particle;
...
final class ParticleResourceEditor : ResourceBaseEditor {
    ...
    void setSpriteRID(string rid) {
        ...
        try {
            auto spriteRes = Studio.getResource("sprite", rid);
...
private final class ParameterWindow : UIElement {
    ...
    this(string spriteRID, string blend, bool isRelativePosition, bool isRelativeSpriteAngle,
...

        {
            ...
            _spriteSelect = new SelectButton(Studio.getResourceList("sprite"), spriteRID);
            _spriteSelect.setWidth(200f);
...
private final class SplineGraph : UIElement {
    private {
